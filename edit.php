...
if(isset($_POST['update'])) {
    ...
    if ($_FILES['foto']['size'] > 0) {
        ...
        $result = mysqli_query($mysqli, "UPDATE tugas SET nama='$nama',email='$email',foto='$foto' WHERE id=$id");
    } else {
        // Update user data without changing the existing photo
        $result = mysqli_query($mysqli, "UPDATE tugas SET nama='$nama',email='$email' WHERE id=$id");
    }
...
$result = mysqli_query($mysqli, "SELECT * FROM tugas WHERE id=$id");
